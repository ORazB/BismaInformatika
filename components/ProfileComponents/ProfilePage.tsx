        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 md:p-8">
          ...
          <div className="lg:hidden space-y-6">
            ...
            <div className="flex flex-col items-center text-center pb-6 border-b border-gray-200">
              <Image
                src={
                  clerkUser.imageUrl || "/profile-page/profile-placeholder.png"
                }
                alt="User Avatar"
                width={150}
                height={150}
              ...
              <div className="space-y-3 w-full">
                ...
                <div className="flex gap-4 flex-col justify-center md:flex-row md:justify-center">
                  <Link
                  ...
                  <button
                    ...
                    className="bg-primary rounded-full ccursor-pointer text-white px-8 py-2.5"
                  >
                    Logout
                  </button>
                </div>
        ...
        <div className="space-y-4 md:space-y-6">
          {allCourses &&
            allCourses.map((course) => (
              <div
                key={course.id}
                className="bg-white rounded-2xl shadow-sm border border-gray-200 p-4 md:p-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4"
              >
                ...
                <div className="flex items-center justify-between md:justify-end gap-4 md:gap-6">
                  {/* Rating Section (Not Implemented yet) */}
