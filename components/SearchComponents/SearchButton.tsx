...
export default function Searchbutton() {
  ...
  return (
    <div className="w-full">
      <input onKeyDown={handleKeyDown} onChange={(text) => setSearchQuery(text.target.value)} id="searchQuery" name="searchQuery" className="p-4 w-full rounded-full border border-gray-text focus:outline-transparent! focus:outline!" type="text" placeholder="Search..."></input>
