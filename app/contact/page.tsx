      ...
      <section className="pt-12 md:pt-20 lg:pt-28">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:place-items-center lg:grid-cols-2 xl:items-start justify-center gap-8 lg:gap-16">
            ...
            <div className="grid w-full h-full grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 lg:gap-6">
              {/* Call Us Card */}
              <div className="bg-white h-full flex flex-col items-center justify-center text-center p-6 gap-1 rounded-2xl border border-gray-200 shadow-sm">
                ...
                <h3 className="text-xl mt-4 mb-2 md:text-2xl font-semibold text-gray-900">
                  Call Us
                </h3>
