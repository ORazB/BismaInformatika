              ...
              <div className="flex-1 w-full">
                <div className="relative">
                  <input
                    ...
                    className="w-full px-4 sm:px-6 py-3 sm:py-4 rounded-full bg-white bg-opacity-20 sm:bg-opacity-30 placeholder-white placeholder-opacity-70 text-text focus:outline-none focus:ring-2 focus:ring-accent text-sm sm:text-base"
                  />
                </div>
